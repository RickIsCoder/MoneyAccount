...
class CoreDataStack {
    ...
    lazy var model: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Amount", withExtension: "momd")!
    ...
    lazy var psc: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Amount")
